...
--   simp only [inc_eq_undir_v12, Emb.trans_fᵥ, Es_spanningsubgraph_fᵥ, CompTriple.comp_eq,
--     map_undir, Sym2.map_pair_eq, hs, ht]
--   simp only [Emb.trans_fₑ, Es_spanningsubgraph_fₑ, Set.mem_range, Function.comp_apply,
--     not_exists]
--   rintro i
--   exact (S.fₑ i).prop
